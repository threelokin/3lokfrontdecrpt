      ...
      <div className=" mx-auto bg-white p-8 rounded-lg shadow-lg">
        ...
        <div className="space-y-6">
          ...
          <section>
            ...
            <p className="text-gray-700">
              If you have any questions or feedback, please feel free to reach out to us at <a href="https://mail.google.com/mail/u/0/?fs=1&to=threelok.in@gmail.com&tf=cm" target="_blank" className="text-blue-600 hover:underline">threelok.in@gmail.com</a>.
            </p>
          </section>
        </div>
      </div>
